...
**Phase**: 1 (Foundation) | **Crate**: facelock-core | **Depends on**: 00
...
pub struct DaemonConfig {
    ...
    pub socket_path: String,       // Default: "/run/facelock/facelock.sock"
    #[serde(default = "default_model_dir")]
    pub model_dir: String,         // Default: "/var/lib/facelock/models"
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct StorageConfig {
    #[serde(default = "default_db_path")]
    pub db_path: String,           // Default: "/var/lib/facelock/facelock.db"
}
...
**Config loading**: Check `FACELOCK_CONFIG` env var first, then `/etc/facelock/config.toml`.
...
- `FACELOCK_CONFIG` env var respected
...
6. `FACELOCK_CONFIG` env var works

## Verification

```bash
cargo test -p facelock-core
cargo clippy -p facelock-core
```
