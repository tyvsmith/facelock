...
use visage_test_support::fixtures;
use visage_test_support::{MockCamera, MockFaceEngine};
...
fn test_config() -> Config {
    let toml = fixtures::test_config_toml("/tmp/visage-test-integ.db", "/tmp/visage-test.sock");
