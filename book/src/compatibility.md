...
|-------------|-------------|------|--------|
| Arch Linux | systemd | daemon + socket activation | Primary target |
...
|-------------|-------------|------|
| Fedora 38+ | systemd | daemon + socket activation |
| Ubuntu 22.04+ | systemd | daemon + socket activation |
| Debian 12+ | systemd | daemon + socket activation |
