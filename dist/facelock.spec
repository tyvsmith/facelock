...
URL:            https://github.com/username/facelock
...
Features include persistent daemon with socket activation for fast
authentication (~50ms), oneshot mode for systems without systemd,
...
install -Dm644 systemd/facelock-daemon.socket %{buildroot}%{_unitdir}/facelock-daemon.socket
...
%systemd_post facelock-daemon.socket facelock-daemon.service
...
%preun
%systemd_preun facelock-daemon.socket facelock-daemon.service

%postun
%systemd_postun_with_restart facelock-daemon.socket facelock-daemon.service
